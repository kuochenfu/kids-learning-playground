...
import { Star, Trophy, ArrowRight, Lightbulb, RefreshCw } from 'lucide-react';
...
const QUESTIONS = [
    {
        ...
        answer: "Mars",
        fact: "Mars has iron oxide on its surface, which gives it a reddish appearance."
    },
    {
        question: "What is the largest animal on Earth?",
        options: ["Elephant", "Blue Whale", "Giraffe", "Colossal Squid"],
        answer: "Blue Whale",
        fact: "A blue whale's tongue alone can weigh as much as an elephant!"
    },
    {
        question: "How many legs does a spider have?",
        options: ["6", "8", "10", "12"],
        answer: "8",
        fact: "All spiders are arachnids, and most have eight eyes too!"
    },
    {
        question: "Which of these is NOT a state of matter?",
        options: ["Solid", "Liquid", "Gas", "Energy"],
        answer: "Energy",
        fact: "Matter is anything that has mass and takes up space. Energy does work!"
    },
    {
        question: "What gas do plants breathe in that we breathe out?",
        options: ["Oxygen", "Nitrogen", "Carbon Dioxide", "Hydrogen"],
        answer: "Carbon Dioxide",
        fact: "Plants use carbon dioxide and sunlight to make their own food!"
    }
];
            ...
            <AnimatePresence mode="wait">
                {gameState === 'idle' && (
                    ...
                    >
                        ...
                        <button onClick={startGame} className="btn-primary bg-sky-500 hover:bg-sky-600 border-sky-700 text-2xl px-12 py-5 rounded-3xl group">
                            Let's Discover! <ArrowRight className="group-hover:translate-x-2 transition-transform" />
                        </button>
                    </motion.div>
                )}
